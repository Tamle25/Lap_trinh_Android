...
class StudentAdapter(
    ...
    private var listener: OnStudentFragment
) :
    RecyclerView.Adapter<StudentAdapter.StudentViewHolder>(), StudentActionListener
{
    ...
    // Thêm đoạn code này vào bên trong class StudentAdapter
    override fun onEditStudent(position: Int, updatedStudent: Student) {
