...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        studentList.add(StudentModel("Nguyễn Thị A", "20200001"))
        studentList.add(StudentModel("Phùng Thanh B", "20200002"))
        studentList.add(StudentModel("Lê Thị C", "20200003"))
        studentList.add(StudentModel("Phạm Văn D", "20200004"))
        studentList.add(StudentModel("Hoàng Thị E", "20200005"))
